...
print('Printing stats for early Anomalous exponent' )
print(stats.f_oneway(A100_1,A250_1))
print(stats.f_oneway(A100_1,A500_1))
print(stats.f_oneway(A250_1,A500_1))
print('Printing stats for late Anomalous exponent' )
print(stats.f_oneway(A100_2,A250_2))
print(stats.f_oneway(A100_2,A500_2))
print(stats.f_oneway(A250_2,A500_2))
print('Printing stats between early and late Anomalous exponent' )
print(stats.f_oneway(A100_1,A100_2))
print(stats.f_oneway(A250_1,A250_2))
print(stats.f_oneway(A500_1,A500_2))
print('------------------------------------------------------------------------')
print('Printing stats for early Diffusion coefficient' )
print(stats.f_oneway(D100_1,D250_1))
print(stats.f_oneway(D100_1,D500_1))
print(stats.f_oneway(D250_1,D500_1))
print('Printing stats for late Diffusion coefficient' )
print(stats.f_oneway(D100_2,D250_2))
print(stats.f_oneway(D100_2,D500_2))
print(stats.f_oneway(D250_2,D500_2))
print('Printing stats between early and late Diffusion Coefficient' )
print(stats.f_oneway(D100_1,D100_2))
print(stats.f_oneway(D250_1,D250_2))
print(stats.f_oneway(D500_1,D500_2))
